...
- [x] A real observed failure is diagnosed from a trace and the fix is measured (evaluator false negatives at 16/18, then judge-driven currency fix lifting usefulness 0.895 to 0.981).
